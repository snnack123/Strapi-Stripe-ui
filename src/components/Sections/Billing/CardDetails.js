...
import { getCardImage } from '../../../utils/utilFunctions';
                ...
                <div>
                    ...
                    <div className='mt-10 flex justify-between border border-gray-200 rounded w-full p-3'>
                        <div className='flex flex-row'>
                            <div className='border border-gray-200 w-16 p-2 flex justify-center rounded'>
                                <div className='pt-2'>
                                    <img src={getCardImage(card.brand)} alt='visa' className='h-5 w-full' />
                                </div>
                            </div>
                            <div className='ml-2 mt-1 truncate text-sm text-gray-500'>
                                ...
                                <div>{cardTypes[card.brand] + ' ending in ' + card.last4}</div>
                                <div>Expiry {card.expMonth + '/' + card.expYear}</div>
                            </div>
                        </div>
